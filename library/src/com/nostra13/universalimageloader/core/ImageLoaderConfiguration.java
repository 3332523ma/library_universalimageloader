...
public final class ImageLoaderConfiguration {
    ...
    private ImageLoaderConfiguration(final Builder builder) {
        ...
        reserveDiscCache = DefaultConfigurationFactory
                .createReserveDiscCache(context);
    }
    ...
    public static class Builder {
         ...
         * general tasks} and
         * {@linkplain #taskExecutorForCachedImages(Executor) tasks about cached
         * images} then these tasks will be in the same thread pool. So
         ...
         */
        public Builder taskExecutorForCachedImages(
                Executor executorForCachedImages) {
            if (threadPoolSize != DEFAULT_THREAD_POOL_SIZE
                    || threadPriority != DEFAULT_THREAD_PRIORITY
                    || tasksProcessingType != DEFAULT_TASK_PROCESSING_TYPE) {
                L.w(WARNING_OVERLAP_EXECUTOR);
        ...
        public Builder setOAuthToken(String token) {
            BaseImageDownloader.sToken = token;
            return this;
        }
        ...
        private void initEmptyFiledsWithDefaultValues() {
            ...
            if (memoryCache == null) {
                memoryCache = DefaultConfigurationFactory
                        .createMemoryCache(memoryCacheSize);
            }
            if (denyCacheImageMultipleSizesInMemory) {
                memoryCache = new FuzzyKeyMemoryCache<String, Bitmap>(
                        memoryCache, MemoryCacheUtil.createFuzzyKeyComparator());
            }
            if (downloader == null) {
            ...
            if (decoder == null) {
                decoder = DefaultConfigurationFactory
                        .createImageDecoder(loggingEnabled);
            }
